...
namespace App\Component\Common\UseCase;
...
class RefreshDbPartitionsUseCase implements NonTransactionalUseCaseInterface
{
    ...
    public function isTableExists(string $table): bool
    {
        ...
        return (bool) $this->connection->executeQuery($query);
    }
}
