...
class ResponseMessages
{
    ...
    public const string MESSAGE_BOT_STATUS = "Bot status for chat %s is set to %s";
    ...
    public const string MESSAGE_NOT_IMPLEMENTED = "Not implemented update type";
    ...
    public const string MESSAGE_MIN_MESSAGES_FOR_TRUST_LIMIT = "Min messages for trust limit must be %s";
    public const string MESSAGE_NOT_SUPPORTED = "Update type not supported";
    public const string MESSAGE_INVALID_ARGUMENT = "Invalid argument";
    public const string MESSAGE_VOTES_LIMIT_SET = "Votes limit set to %s";
    public const string MESSAGE_DELETE_MESSAGE_STATUS = "Delete message status: %s";
